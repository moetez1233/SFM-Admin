    ...
    return ( <
        ...
        Card.Body className = 'infoPatient' > { ' ' } {
            clicked ? ( <
                ...
                div > { ' ' } <
                /Grid>{' '} <
                Grid item xs = { 7 } > { ' ' } { clickedPatient.Firstname } { clickedPatient.lastname } { ' ' } <
                /Grid>{' '} < /
                Grid > { ' ' } <
                Grid container spacing = { 3 } >
                <
                ...
                div > { ' ' } <
                /Grid>{' '} <
                Grid item xs = { 7 } > { ' ' } { clickedPatient.email } { ' ' } <
                /Grid>{' '} < /
                Grid > { ' ' } <
                Grid container spacing = { 3 } >
                <
                ...
                div > { ' ' } <
                /Grid>{' '} <
                Grid item xs = { 7 } > { ' ' } { clickedPatient.ContactNumber } { ' ' } <
                /Grid>{' '} < /
                Grid > { ' ' } <
                Grid container spacing = { 3 } >
                <
                ...
                div > { ' ' } <
                /Grid>{' '} <
                Grid item xs = { 7 } > { ' ' } { clickedPatient.Country } { ' ' } <
                /Grid>{' '} < /
                Grid > { ' ' } <
                Grid container spacing = { 3 } >
                <
                ...
                div > { ' ' } <
                /Grid>{' '} <
                Grid item xs = { 7 } > { ' ' } { clickedPatient.ville } { ' ' } <
                /Grid>{' '} < /
                Grid > { ' ' } <
                Grid container spacing = { 3 } >
                <
                ...
                div > { ' ' } <
                /Grid>{' '} <
                Grid item xs = { 7 } > { ' ' } { clickedPatient.Centredetest } { ' ' } <
                /Grid>{' '} <
                Grid item xs = { 2 } >
                <
                EditIcon > < /EditIcon>{' '} < /
                ...
                div > { ' ' } <
                /Grid>{' '} <
                Grid item xs = { 7 } > { ' ' } { clickedPatient.time } { ' ' } <
                /Grid>{' '} <
                Grid item xs = { 2 } > { ' ' } <
                ...
                div > { ' ' }
                Click sur le patient que tu veux chercher pour voir leur information { ' ' } <
                /div>
            )
        } { ' ' } <
        /Card.Body>{' '} < /
